...
public class BossNodeSakuya extends Node {
	public static final int MAXHP = 600;
	public static final int SHOTMAGNITUDE = 70;
	public static final int MAGNITUDE = 120;
	Node torso;
	private static final float changeFactor = 1f;
	...
	public BossNodeSakuya() {
		destination = new Vector3();
		torso = new Node();
		
		Texture texture = new Texture(Gdx.files.internal("textures/sakuya.png"));
		Material mat = new Material("mat", new TextureAttribute(texture, 0, "s_tex"), new ColorAttribute(Color.WHITE, ColorAttribute.diffuse));

		
		torso.setModel( ModelLoaderRegistry.loadStillModel(Gdx.files.internal("models/sakuyag.g3dt")));

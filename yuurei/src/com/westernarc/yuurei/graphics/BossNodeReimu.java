...
public class BossNodeReimu extends Node {
	public static final int MAXHP = 600;
	public static final int SHOTMAGNITUDE = 180;
	public static final int MAGNITUDE = 40;
	Node torso;
	...
	public BossNodeReimu() {
		destination = new Vector3();
		torso = new Node();
		
		Texture texture = new Texture(Gdx.files.internal("textures/reimutex.png"));
		Material mat = new Material("mat", new TextureAttribute(texture, 0, "s_tex"), new ColorAttribute(Color.WHITE, ColorAttribute.diffuse));
		
		torso.setModel( ModelLoaderRegistry.loadStillModel(Gdx.files.internal("models/reimu.g3d")));
